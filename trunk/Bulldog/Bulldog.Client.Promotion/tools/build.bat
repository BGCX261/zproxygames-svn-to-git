...
@call :mxmlc Bulldog/Client/Promotion/ActionScript Application
...
::call C:\util\flex\bin\mxmlc.exe -use-network=false -debug -keep-as3-metadata -incremental=true -output=%2.swf -strict -sp=. %1/%2.as
goto :eof